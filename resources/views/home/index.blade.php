...
<<<<<<< HEAD
                                                <input type="text" disabled class="form-control" id="updateinputidtrailer" name="updateinputidtrailer" value="{{ old('updateinputidtrailer') }}">
=======
...
>>>>>>> a690ff291518f777e105c82b831655ab6a0d58db
